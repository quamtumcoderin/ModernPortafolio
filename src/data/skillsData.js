...
export const skillsDescription = {
    ...
    subtitle: 'Más allá del código: La ingeniería es humana.',
    text: 'Mi enfoque no se limita a la sintaxis. Priorizo la arquitectura escalable, la comunicación clara con los stakeholders y la capacidad de pivotar rápidamente ante nuevos requisitos tecnológicos.'
}